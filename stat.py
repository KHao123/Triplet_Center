...
method2path = {
	...
	# 'Triplet' : ['run/result/skinRes/iterNo{}/margin0.5_128d-embedding_RandomNegativeTripletSelector'.format(i+1) for i in range(5)],
	'T-Center' : ['run/result/skinRes/iterNo{}/CenterlossV2_margin0.5_128d'.format(i+1) for i in range(5)]
} 
...
if __name__ == '__main__':
	...
	Result.to_csv('stat_20_centerV2.csv')
