...
from losses import OnlineTripletLoss,OnlineContrastiveLoss,OnlineCenterLoss,OnlineCenterLossV2
...
if __name__ == '__main__':
	...
	loss_fn = OnlineCenterLossV2(margin)
	...
	output_writer_path = os.path.join('./run', '{}/iter{}/Centerloss_margin{}_{}d'.format(dataset_name,args.iterNo,margin,args.dim))
